	...
	<body>
		<div class="container">
			<a href=""><img class="logo"
					src="https://drive.google.com/file/d/1xU4a_V9FRnKb5ByKyy2FdKEPrTFyv7EW/view?usp=sharing" alt="Hive Logo"></a>
			<div class="message">OTP Verification Email</div>
			<div class="body">
				<p>Dear ${name}</p>
				<p>Thank you for registering with Hive. To complete your registration, please use the following OTP
